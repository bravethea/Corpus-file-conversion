...
def demo():
    ...
    print("\nFormat mine")
    path_mine = "/Users/teodoravukovic/Google Drive (not syncing)/PycharmProjects/VIAN-file-conversion/PRAAT/samples/Mary_John_bell.TextGrid"
    text_mine = open(path_mine, 'r', encoding="utf16").read()
    demo_TextGrid(text_mine)
